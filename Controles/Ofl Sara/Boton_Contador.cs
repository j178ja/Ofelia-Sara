...
//                    // Eliminar del menú los elementos que ya no están en la lista
//                    foreach (ToolStripItem item in listaDesplegable.Items.Cast<ToolStripItem>().ToList())
//                    {
//                        if (!elementos.Contains(item.Text))
//                        {
//                            listaDesplegable.Items.Remove(item);
//                        }
//                    }
//                }
//            });
...
//                // Si se desactiva el botón, eliminar los elementos
//                if (!value)
//                {
...
//                // Si se deshabilita, eliminar los elementos
//                if (!value)
//                {
//                    listaDesplegable.Items.Clear();
//                    this.Text = "0";
