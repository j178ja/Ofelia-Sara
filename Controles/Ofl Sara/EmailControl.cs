...
namespace Ofelia_Sara.Controles.Ofl_Sara
{
    public partial class EmailControl : UserControl
    {
        ...
        public EmailControl()
        {
            InitializeComponent();
            ConfigurarTxtEmail();
            comboBox_EmpresaEmail.InnerTextBox.MaxLength = 20;
        ...
        private void AjustarLongitudComboBox(CustomComboBox customComboBox)
        {
            // Mide el tamaño del texto contenido en el ComboBox
            Size textSize = TextRenderer.MeasureText(customComboBox.Text, customComboBox.Font);

            // Ajusta el ancho del ComboBox según el tamaño del texto
            customComboBox.Width = textSize.Width + 20; // Añade un margen para padding y desplegable
        }
