...
public static class ToolTipError
{
    ...
    public static void ShowToolTip(Control control, string toolTipText)
    {
        ...
        // No es necesario calcular la posición manualmente, el ToolTip lo maneja automáticamente
        // Si quieres cambiar la posición o la duración, puedes hacerlo aquí si es necesario
    }
